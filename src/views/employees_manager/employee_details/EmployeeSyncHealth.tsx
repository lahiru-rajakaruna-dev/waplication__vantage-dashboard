...
export default function EmployeeSyncHealth() {
    ...
    const query_GetEmployeeSyncProfile = useQuery(() => {
        return {
            queryKey: [
                'employee-sync',
            ...
            queryFn : async () => {
                return api.EmployeeSyncApi.getProfile(getSelectedEmployeeId())
            }
        }
    })
    ...
    return <div class={ 'row-start-1 row-span-2 col-start-9 col-span-4 card' }>
        ...
        <Show
                when={ query_GetEmployeeSyncProfile.data }
        ...
        >
            <div class={ 'relative w-full h-full' }>
                ...
                <pre class={ 'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-8/12 text-8xl font-black' }>
                      { new Date(query_GetEmployeeSyncProfile.data!.employee_sync_last_synced_timestamp).toLocaleDateString() }
                    </pre>
